...
class QuestionCommentsControllerTest < ActionController::TestCase
  ...
  test "should create question_comment" do
    assert_difference('QuestionComment.count') do
      post :create, question_comment: { content: @question_comment.content, question_id: @question_comment.question_id, user_id: @question_comment.user_id }
    end
  ...
  test "should update question_comment" do
    patch :update, id: @question_comment, question_comment: { content: @question_comment.content, question_id: @question_comment.question_id, user_id: @question_comment.user_id }
    assert_redirected_to question_comment_path(assigns(:question_comment))
  end
